...
weir_imgs = glob.glob(scanpath + '**/*.jpeg')
weir_imgs = [ x for x in weir_imgs if "stitch" not in x ]
...
keypoints_center_img = finder.draw_keypoints(medium_imgs[36], features[36])
